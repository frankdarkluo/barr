# Week 1 Transition-Probe Pilot: Codex Execution Plan
...
This plan follows [Efficiency.md](/home/gluo/barr/Efficiency.md):
- plan before coding
...
The current [vanilla.py](/home/gluo/barr/vanilla.py) path is good for answer extraction and fairness scoring, but it is not the right primary runner for this pilot because:
...
Recommendation:
- keep [vanilla.py](/home/gluo/barr/vanilla.py) as the baseline/reference runner
...
- create [AGENTS.md](/home/gluo/barr/AGENTS.md) wrapper
...
- build the same thinking-mode prompt logic used in [vanilla.py](/home/gluo/barr/vanilla.py)
